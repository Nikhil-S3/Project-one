            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php if($_SESSION['module_permissions'][28]['p_add'] == '1'){ ?>
                    <a href="<?php echo base_url();?>tattendance/add">
                      <button type="submit" class="btn btn-success">Add Teacher Attendance</button>
                    </a>
                  <?php } ?>
                          ...
                          <table id="datatable-fixed-header" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php if(!empty($all_teachers)) { 
                                      $i = 1;
                                      foreach( $all_teachers as $sa_key => $sa_val ){
                                ?>
                              <tr>
                                <td><?php echo $i++; ?></td>
                                ...
                                <td>
                                  <?php if($_SESSION['module_permissions'][28]['p_view'] == '1'){ ?>
                                    <a href="<?php echo base_url().'tattendance/view/'.$sa_val->id; ?>">
