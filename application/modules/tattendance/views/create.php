              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="teacher_attendance_form" class="form-inline" action="<?php echo base_url();?>tattendance/add" method="post">
                      ...
                      <?php if(isset($teacher_attendance_info) && count($teacher_attendance_info)>0) { ?>
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <?php $count=1; foreach( $teacher_attendance_info as $sa_key => $sa_val ){ ?>
                          <tr>
                            <td><?php echo $count++; ?></td>
                            <td><?php echo $sa_val->preferred_name; ?></td>
                            <td><?php echo $sa_val->email; ?></td>
                            <td><?php echo $sa_val->designation; ?></td>
                            <td>
