  ...
  <head>
    ...
    <link href="<?php echo base_url(); ?>assets/build/css/custom.min.css" rel="stylesheet">
      ...
      <?php $this->load->view('common/header.php'); ?>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <!-- <a href="<?php //echo base_url();?>parents/add"> -->
                    <?php if($_SESSION['module_permissions'][4]['p_add'] == '1'){ ?>
                      <button type="submit" class="btn btn-success" data-toggle="modal" data-target="#addParentModal" >Add User</button>
                    <?php } ?>
                  <!-- </a> -->
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($_SESSION['module_permissions'][4]['p_edit'] == '1'){ ?>
                              <a href="<?php echo base_url().'users/edit/'.$u_val->id; ?>">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                              </a> 
                            <?php $continue .= '|'; } if($_SESSION['module_permissions'][4]['p_delete'] == '1'){ echo $continue; ?>
                              <a href="<?php echo base_url().'users/delete/'.$u_val->id; ?>" onclick="return confirm('Are you sure you want to delete this user?');">
        ...
        <?php $this->load->view('add_user_modal.php'); ?>
