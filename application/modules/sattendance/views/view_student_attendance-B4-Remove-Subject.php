              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="x_content">
                      <?php if($attendance_student_data->photo!=''){ ?>
                            ...
                            <table class="attendance_table table-bordered">
                              ...
                              <tbody>
                                  <?php foreach($month_arr as $mk=>$mv){ ?>
                                    <tr>
                                      <td><?php echo $mv; ?></td>
                                      <?php // foreach($days_arr as $dayk=>$dayv){ 
                                        for($i=1;$i<32;$i++){
                                          $initial_ival = $i;
                                         foreach($student_attendance as $sak=>$sav){
                                            // echo "<pre>";print_r($sav);exit;
                                            foreach($sav as $key=>$val){
                                              if($val->subject_name==$sv->subject_name){
                                                if($val->day==$i && $mk==$val->month){
                                                  $i = $i+1;
                                                  echo '<td>'.$val->attendance.'</td>'; 
                                                } 
                                                else{
                                                  echo '<td>N/A</td>'; 
                                                }
