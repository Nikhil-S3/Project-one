                          ...
                          <table id="datatable-fixed-header" class="table table-striped table-bordered">
                            ...
                            <tbody>
                              <?php if(!empty($all_modules)) { 
                                      $i = 1;
                                      foreach( $all_modules as $m_key => $m_val ){
                                ?>
                              <tr>
                                <td><?php echo $i++; ?></td>
                                <td><?php echo $m_val->preferred_name; ?></td>
                                <td><?php echo $m_val->email; ?></td>
                                <td><?php echo $m_val->designation; ?></td>
                                <td>
                                    <a href="<?php echo base_url().'tattendance/view/'.$m_val->id; ?>">
