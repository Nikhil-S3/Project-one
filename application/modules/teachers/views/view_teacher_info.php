                    ...
                    <div class="x_content">
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                          ...
                          Joining Date : <?php echo date('d M Y',strtotime(@$teacher_info->joining_date)); ?> <br>
                          Religion: <?php echo @$teacher_info->religion; ?>
                          <br> 
                          Email: <?php echo @$teacher_info->email; ?><br> 
                          Address: <?php echo @$teacher_info->address; ?><br> 
                          Username: <?php echo @$teacher_info->username; ?>
                          <br>
                        </div>
