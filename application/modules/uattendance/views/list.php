            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <?php if($_SESSION['module_permissions'][9]['p_add'] == '1'){ ?>
                    <a href="<?php echo base_url();?>uattendance/add">
                      <button type="submit" class="btn btn-success">Add User Attendance</button>
                    </a>
                  <?php } ?>
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php if($_SESSION['module_permissions'][9]['p_view'] == '1'){ ?>
                                    <a href="<?php echo base_url().'uattendance/view/'.$u_val->id; ?>">
