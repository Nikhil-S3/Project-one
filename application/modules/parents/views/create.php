                    ...
                    <form id="add_parent_form" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url();?>parents/save" method="post" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="parent_guardian_name" name='parent_guardian_name' class="form-control col-md-7 col-xs-12" value="<?php echo set_value('parent_guardian_name'); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="parent_father_name">Father's Name </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="parent_father_name" name="parent_father_name" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('parent_father_name'); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="parent_mother_name" class="form-control col-md-7 col-xs-12" type="text" name="parent_mother_name" value="<?php echo set_value('parent_mother_name'); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="parent_father_profession" class="control-label col-md-3 col-sm-3 col-xs-12">Father's Profession</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="parent_father_profession" class="form-control col-md-7 col-xs-12" type="text" name="parent_father_profession" value="<?php echo set_value('parent_father_profession'); ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="parent_mother_profession" class="control-label col-md-3 col-sm-3 col-xs-12">Mother's Profession</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="parent_mother_profession" class="form-control col-md-7 col-xs-12" type="text" name="parent_mother_profession" value="<?php echo set_value('parent_mother_profession'); ?>">
                        </div>
                      </div>
                      <div class="form-group">
