              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="student_form" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url();?>students/save" method="post" enctype="multipart/form-data" >

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="preferred_name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="preferred_name" name='preferred_name' class="form-control col-md-7 col-xs-12" value="<?php echo set_value('preferred_name'); ?>">
                        </div>
                      </div>
                      <div class="form-group">
