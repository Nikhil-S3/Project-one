              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="student_form" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url();?>students/update" method="post" enctype="multipart/form-data">

                      <input type="hidden" id="student_id" name='student_id' class="form-control col-md-7 col-xs-12" value="<?php echo $student_info->id; ?>">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="preferred_name">Name <span class="required">*</span>
                        </label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Guardian </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select id="guardian" name="guardian" class="form-control">
                            ...
                            <option value="guardian1" <?php echo ($student_info->guardian=='guardian1')?'selected':''; ?> >Guardian1</option>
                            <option value="guardian2" <?php echo ($student_info->guardian=='guardian2')?'selected':''; ?> >Guardian2</option>
                            <option value="guardian3" <?php echo ($student_info->guardian=='guardian3')?'selected':''; ?> >Guardian3</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Blood Group</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="state" class="form-control col-md-7 col-xs-12" type="text" name="state" value="<?php echo $student_info->state; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="student_class" name="student_class" class="form-control">
                            ...
                            <option value="one" <?php echo ($student_info->student_class=='one')?'selected':''; ?> >One</option>
                            <option value="two" <?php echo ($student_info->student_class=='two')?'selected':''; ?> >Two</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="section" name="section" class="form-control">
                            ...
                            <option value="a" <?php echo ($student_info->section=='a')?'selected':''; ?> >A</option>
                            <option value="b" <?php echo ($student_info->section=='b')?'selected':''; ?> >B</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="optional_subject" name="optional_subject" class="form-control">
                            ...
                            <option value="subject1" <?php echo ($student_info->optional_subject=='subject1')?'selected':''; ?> >subject1</option>
                            <option value="subject2" <?php echo ($student_info->optional_subject=='subject2')?'selected':''; ?> >subject2</option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="register_no" class="form-control col-md-7 col-xs-12" type="text" name="register_no" value="<?php echo $student_info->register_no; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="roll_no" class="control-label col-md-3 col-sm-3 col-xs-12">Roll</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="roll_no" class="form-control col-md-7 col-xs-12" type="text" name="roll_no" value="<?php echo $student_info->roll_no; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="extra_curricular_activities" class="control-label col-md-3 col-sm-3 col-xs-12">Extra Curricular Activities</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="extra_curricular_activities" class="form-control col-md-7 col-xs-12" type="text" name="extra_curricular_activities" value="<?php echo $student_info->extra_curricular_activities; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="remarks" class="control-label col-md-3 col-sm-3 col-xs-12">Remarks</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="remarks" class="form-control col-md-7 col-xs-12" type="text" name="remarks" value="<?php echo $student_info->remarks; ?>">
                        </div>
                      </div>
                      <div class="form-group">
